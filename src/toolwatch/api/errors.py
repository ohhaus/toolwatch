...
def _message_for(code: str) -> str:
    messages = {
        ...
        "agent_provider_not_allowed": "The requested agent provider is not allowed.",
        "agent_model_not_allowed": "The requested model is not allowed.",
        "agent_tool_schema_error": "Enabled tools cannot be represented safely for the model.",
        "agent_provider_error": "The local agent provider failed.",
        "ollama_unavailable": "The local Ollama service is unavailable.",
        "ollama_timeout": "The local Ollama request timed out.",
        "ollama_invalid_response": "Ollama returned an invalid response.",
        "ollama_model_not_found": "The configured Ollama model was not found.",
        "invalid_provider_response": "The agent provider returned an invalid response.",
        "agent_turn_limit_reached": "The agent turn limit was reached.",
        "agent_tool_call_limit_reached": "The agent tool-call limit was reached.",
        "agent_tools_per_turn_limit_reached": "The per-turn tool-call limit was reached.",
        "agent_run_timeout": "The agent run timed out.",
        "agent_message_too_large": "An agent message exceeded the configured limit.",
        "agent_conversation_too_large": "The agent conversation exceeded the configured limit.",
    }
